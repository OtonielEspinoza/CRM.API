...
namespace CRM.DTOs.CustomerDTOs
{
   public class EditCustomerDTO
    {
        public EditCustomerDTO(GetIdResultCustomerDTO getIdResultCustomer)
        {
            Id = getIdResultCustomer.Id;
            Name = getIdResultCustomer.Name;
            LastName = getIdResultCustomer.LastName;
            Address = getIdResultCustomer.Address;
        }
